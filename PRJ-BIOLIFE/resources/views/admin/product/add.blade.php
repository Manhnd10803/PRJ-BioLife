    ...
    <script>
        function validate(){
            ...
            if(discounts == ''){
                ...
                check = false;
            }else if(discounts >= price){
                error_discounts.innerHTML = 'The field is invalid';  
                check = false;
            }else{
        ...
        <form action="{{ route('admin.product.store') }}" method="post" class="form-control" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    ...
                    <input type="text" name="discounts" id="discounts" class="form-control">
            ...
            <div class="row">
                ...
                <div class="col-xl-3">
                    ...
                    <input type="text" name="weight" id="weight" class="form-control" min="0">
