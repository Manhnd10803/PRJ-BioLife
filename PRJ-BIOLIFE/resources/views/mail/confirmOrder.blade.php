	      ...
	      <tr>
	      	<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
	      		<tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					    <th width="60%" style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px">Products</th>
                        <th width="20%" style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px">Quantity</th>
					  ...
					  <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					  	<td valign="middle" width="60%" style="text-align:left; padding: 0 2.5em;">
					  		<div class="product-entry">
                                <img src="{{ asset('storage/'.$pro->srcImage) }}" alt="" style="width: 100px; max-width: 600px; height: auto; margin-bottom: 20px; display: block;">
                        ...
                        <td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">{{ $pro->quantity }}x</td>
					  	<td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">
					  		<span class="price" style="color: #000; font-size: 20px;">$ {{$pro->priceProduct }}  <del style="color: red">$ {{$pro->priceSaleProduct }}</del></span>
					  	</td>
					  </tr>
                    ...
                    @endforeach
					  ...
					  <tr>
					  	<td valign="middle" style="text-align:left; padding: 1em 2.5em;">
					  		<p><a href="{{ url('/product') }}" class="btn btn-primary">Continue to your order</a></p>
					  	</td>
					  </tr>
	      	</table>
	      </tr><!-- end tr -->
